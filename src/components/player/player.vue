...
const transitionDuration = prefixedStyle('transitionDuration')
...
export default {
  ...
  methods: {
    ...
    handleLyric ({lineNum, txt}) { //控制歌词滚动
    ...
    middleTouchEnd () {
      ...
      const time = 300
      this.$refs.lyricList.$el.style[transform] = `translated(${offsetWidth}px, 0, 0)`
